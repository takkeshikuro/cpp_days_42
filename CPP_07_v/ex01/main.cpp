...
/*   Updated: 2024/02/08 02:53:59 by tmorikaw         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void    test_arr_int()
{
	...
	::iter(arr_int, 6, function_test<int>);
...
void    test_arr_double()
{
	...
	::iter(arr_double, 6, function_test<double>);
...
void    test_arr_string()
{
	...
	::iter(arr_string, 4, function_test<std::string>);
